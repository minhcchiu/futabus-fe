<template>
  <div class="flex w-full flex-col">
    <div class="flex items-center justify-between gap-4">
      <span class="text-lg font-medium md:text-2xl">15:00</span>
      ...
      <span class="text-lg font-medium md:text-2xl">06:00</span>
    </div>
    <div class="mt-3 flex justify-between text-[13px] font-normal">
      <div class="flex-1">
        <span class="text-sm font-medium md:text-[15px]">Bến Xe Đắk Nông</span
        ><br /><span class="text-gray mt-2" />
      </div>
      <div class="flex-1 text-right">
        <span class="text-sm font-medium md:text-[15px]"
          >Bến Xe Trung Tâm Đà Nẵng</span
        ><br /><span class="text-gray mt-2" />
      </div>
    </div>
  </div>
